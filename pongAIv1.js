...
model.add(tf.layers.dense({units: 256, inputShape: [8]})); /*input shape 8 represents: 
...
var update = function () {
player.update();
if(computer.ai_plays){ // if ai is controlling ball, use predictions to move computer paddle
